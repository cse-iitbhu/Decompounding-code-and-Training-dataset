...
encoder = LSTM(latent_dim, return_state=True, dropout=dp)
...
decoder_lstm = LSTM(latent_dim, return_sequences=True, return_state=True, dropout=dp)
...
encoder_inf_out = Input(shape=(latent_dim,))
