...
encoder = SimpleRNN(latent_dim, return_state=True, dropout=dp)
encoder_outputs, final_state = encoder(encoder_inputs)


decoder_inputs = Input(shape=(None, num_tokens))

decoder_rnn = SimpleRNN(latent_dim, return_sequences=True, return_state=True, dropout=dp)
decoder_outputs, _ = decoder_rnn(decoder_inputs, initial_state=final_state)
...
decoder_outputs, state_h = decoder_rnn(decoder_inputs, initial_state=decoder_states_inputs)
